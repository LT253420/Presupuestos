...
{/* Acá va el Costo De la revisión fijo */}
const COSTO_REVISION = 10000;


export default function RevisionScreen({ onBack }: Props) {
...
{/* Acá empieza el redondeo Del pin */}
  function redondearPrecioRevision(valor: number) {
...
function calcularRevision() {
  ...
  setTimeout(() => {
    ...
    const conGanancia = COSTO_REVISION * 2.10;

    const final = redondearPrecioRevision(conGanancia);
...
🛠️ Revisión / Diagnóstico

💰 Valor Total de la reparación:

${resultado} Hasta $30.000 Según Modelo de Telefono

────────────────────────────

⚠️ En caso de aceptar la reparación,
el valor del diagnóstico podrá descontarse
        ...
        <div className="max-w-md mx-auto space-y-4">
          ...
          >
            ...
            <h2 className="text-xl font-bold text-center">
              Calculador Presupuestos <br></br> Revisión / Diagnóstico
            </h2>
